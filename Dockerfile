...
ARG PACKAGIST_NAME="infection/infection"
ARG PHPQA_NAME="infection"
ARG VERSION="0.9.0-beta.2"
...
# Install Infection - Mutation Testing framework - https://github.com/infection/infection
